...
/** Métodos expuestos por SwipeCard via ref */
 ...
 * Expone swipeLeft() y swipeRight() via ref para control programático.
 */
export const SwipeCard = React.memo(
  React.forwardRef<SwipeCardRef, SwipeCardProps>(
    ({ asset, onSwipeLeft, onSwipeRight, isTop }, ref) => {
